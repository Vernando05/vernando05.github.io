(function () {
	...
	var objectHeight = document.getElementById('particles-object').clientHeight;
	var objectWidth = document.getElementById('particles-object').clientWidth;
	init();
	animate();
	function init() {
	...
	function onWindowResize() {
		...
		objectHeight = document.getElementById('particles-object').clientHeight;
		objectWidth = document.getElementById('particles-object').clientWidth;
		renderer.setSize( objectWidth, objectHeight );
	}
